...
const CarCard: NextPage<Props> = ({
    ...
    const handleSubmit = () => {
        if (!carFilters?.pickup_location || !carFilters?.dropoff_location || !carFilters?.pickup_date || !carFilters?.dropoff_date || !carFilters?.car_class || !carFilters?.pickup_time) {
            messageApi.open({
                type: 'error',
    ...
    return (
        ...
        >
            {contextHolder}
            <Image alt="image_not_found" className="w-full" height={400} width={200} src={"https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRpGQhzz_SIPshxwx1Nltfi8KWUaKddWJvv3efrEwv-kA&s"} />
