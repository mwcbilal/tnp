    ...
    <div className="container  mx-auto flex flex-col lg:flex-row lg:items-center justify-center  my-16 w-[90%]">
      ...
      <div className="lg:w-1/2 lg:pl-8">
        <h2 className="text-2xl font-bold mb-4 text-center lg:text-left">
          Best money - saving <br></br>{" "}
          <span className={`text-primary text-4xl ${inter.className}`}>
            {" "}
            Travel
          </span>{" "}
          Trips
        ...
        <p className="mb-4 text-center lg:text-left">
          See how I helped real readers plan, save and go on the trip of
          lifetime. And get{" "}
          <span className="">
            {" "}
        ...
        <div className="flex justify-center lg:justify-normal items-center">
          <button className="bg-primary text-white py-2 px-5 rounded">
            DOWNLOAD{" "}
          </button>
        </div>
      </div>
