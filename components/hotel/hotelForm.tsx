...
const Hotelform = () => {
    ...
    return (
        <div className="bg-white mx-auto flex flex-col gap-4 lg:items-center justify-center my-16 w-[80%] max-w-screen-xl">
            {contextHolder}
            <h1 className="lg:text-3xl text-1xl font-semibold my-2 text-center ">
                HOTEL BOOKING FORM
            </h1>

            <div className="w-full flex flex-col lg:flex-row gap-5 my-4 ">
                <div className="lg:w-[32%]  my-2 flex flex-col">
                    <label htmlFor="destination" className="text-black ml-2 mb-2">
                        Destination
                    </label>
                    ...
                    <div className="relative">
                        ...
                        >
                            ...
                            {destinations?.map((dest, i) => {
                                return (
                                    <option value={dest?.destination_id} key={1024 + i}>
                                        {" "}
                ...
                <div className="lg:w-[32%]  my-2 flex flex-col">
                    ...
                    <div className="relative">
                        ...
                        >
                            ...
                            {filteredHotels?.map((hotel: any, i) => {
                                return (
                                    <option value={hotel?.hotel_id} key={145 + i}>{hotel?.hotel_name}</option>
                                );
                            })}
                        </select>
                        <div className="absolute inset-y-0 right-0 flex items-center justify-center pointer-events-none">
                ...
                <div className="lg:w-[32%]  my-2 flex flex-col">
                    <label htmlFor="checkInDate" className="text-black ml-3 mb-2">
                        Check-In{" "}
                    </label>
                    <input
                        id="checkInDate"
            ...
            <div className="w-full flex flex-col lg:flex-row gap-5 my-4 ">
                <div className="lg:w-[32%]  my-2 flex flex-col">
                    <label htmlFor="checkOutDate" className="text-black ml-2 mb-2">
                        Check-Out{" "}
                    </label>
                    <input
                        id="checkOutDate"
