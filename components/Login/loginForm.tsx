    ...
    return (
        <div className="  bg-white mx-auto flex flex-col lg:flex-row lg:items-center justify-center  my-16 w-[90%]">
            ...
            <div className="lg:w-[60%] lg:pl-8">
                <h2 className="text-black text-3xl my-1 font-bold mb-4 text-center lg:text-left ">Create An Account To Get started</h2>
                <span className="mb-4  p-1 text-white rounded-sm h-8 bg-yellow-400 w-[10rem] ">20% OFF</span> <span>get 20% off foe web signup</span>
                ...
                <div className="mb-4">
                    <label htmlFor="Your password" className="block text-gray-700 font-bold mb-2">Your password </label>
                    <div className="relative">
                        <input
                            type="password"
                            id="password"
                ...
                <div className='flex justify-center items-center' >
                    ...
                    <div className='w-[50%] h-[1px] rounded-sm  bg-gray-200'> </div><span className=' mx-5' >OR</span>
                ...
                <div className='flex flex-col lg:flex-row my-3 gap-4'>
                    <button className="bg-white text-black py-2 px-5 rounded flex items-center border border-gray-400">
                        <Image src={googlepic} alt="Google icon" className="w-6 h-6 mr-2" /> Sign In with Google
                    </button>
                    <button className="bg-white text-black py-2 px-5 rounded flex items-center border border-gray-300">
                        <Image src={facebookpic} alt="Facebook icon" className="w-6 h-6 mr-2" /> Sign In With Facebook
                    </button>
                </div>
                ...
                <div className='flex justify-center lg:justify-normal items-center'>
                    ...
                    <button className="bg-primary w-full hover:bg-blue-600 text-white py-2 px-5 rounded">SIGN IN </button>
                </div>
                ...
                <div className="flex items-center my-3">
                    ...
                    <label htmlFor="termsCheckbox" className="ml-2 text-gray-700">
                        By signing up, you agree to Customers.ai’s Terms Of Service and Privacy Policy
                    </label>
                </div>
