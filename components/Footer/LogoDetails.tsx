  ...
  return (
    <div className="min-w-72 max-w-80">
      ...
      <div className="flex w-52 justify-between">
        <Image src={sc0} alt="not_found_image" width={40} height={40} />
        <Image src={sc1} alt="not_found_image" width={40} height={40} />
        <Image src={sc2} alt="not_found_image" width={40} height={40} />
        <Image src={sc3} alt="not_found_image" width={40} height={40} />
      </div>
