...
const page = () => {
    ...
    const time = new Date(dropoff_date).getTime() - new Date(pickup_date).getTime()
    ...
    const handleSubmit = async () => {
        const res = await axios.post("/pages/api/car/booking", {
            pickup_location,
            dropoff_location,
            pickup_date,
            dropoff_date,
    ...
    return (
        <div>
            ...
            <div className="bg-[#fbad17] w-full h-[100px] flex flex-row items-center">
                ...
                />
                <h1 className="text-black text-[30px] ml-2 font-semibold cursor-pointer" onClick={()=>router.back()}>Back</h1>
            </div>
            ...
            <div className="w-full lg:w-[80%] flex flex-col lg:flex-row gap-6 justify-center mx-auto my-10">
                ...
                <div className=" w-full lg:w-[80%] ml-3 mr-3 mt-10">
                        ...
                        <table className="w-full text-md text-left rtl:text-right text-black dark:text-blue-100">
                            ...
                            <tbody>
                                <tr className="bg-transparent border-b border-gray-200 ">
                                    ...
                                    <td className="px-6 py-7 text-gray-400">PKR {selectedCar?.pricePerDay}/day</td>
                                    <td className="px-6 py-7 text-gray-400">{daysDifference}</td>
                                    <td className="px-6 py-7 text-gray-400">{selectedCar?.pricePerDay * daysDifference}</td>
                                </tr>
                                <tr className="bg-transparent border-b border-gray-200">
                                    <th
                                        scope="row"
                                ...
                                <tr className="bg-transparent border-b border-gray-200">
                                    ...
                                    <td className="px-6 py-7 text-gray-400">{selectedCar?.pricePerKm}/km</td>
                                    <td className="px-6 py-7"></td>
                                    <td className="px-6 py-7"></td>
                                </tr>
                                <tr className="bg-transparent border-b border-gray-200">
                    ...
                    <div className="flex flex-col lg:flex-row justify-between mt-[4rem] mb-[5rem] ml-[10px]">
                        ...
                        <h1 className="text-[#fbad17] text-[40px] font-bold">PKR {(selectedCar?.pricePerDay * daysDifference) + 225}</h1>
                    </div>
