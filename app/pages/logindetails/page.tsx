    ...
    <div className="w-full h-full flex justify-center mb-[5rem]">
      <div className="lg:w-[50%] md:w-[70%] w-[90%] flex flex-col gap-8 py-8">
        <div className="flex flex-col gap-2">
          ...
          <button
            className="border-none font-semibold  w-[95px]"
        ...
        <div className="flex flex-col w-full gap-16">
          <div className="flex sm:flex-row flex-col gap-4 w-full">
            <div className="sm:w-[45%] w-[90%] flex flex-col gap-2">
              <p>Name</p>
              {editingusername?  <div className="w-full relative">
          <input
            type="text"
            value={newUsername}
          ...
          />
          <button className="absolute z-10 w-8 border-none left-[90%] mt-2" onClick={()=>{
            setEditingusername(false);
            setUsername(newUsername);
          }}><MdOutlineDownloadDone size={25}/></button>
        </div> : <div className="w-full bg-yellow-400 relative">
                <input  
                  type="text"
                  value={username}
                  readOnly={true}
            ...
            <div className="sm:w-[45%] w-[90%] sm:mt-0 mt-10 flex flex-col gap-2">
              <p>Email</p>
              {editingmail?  <div className="w-full relative">
          <input
            type="email"
            value={newEmail}
            ...
            className="py-2 pr-10 pl-3 border border-gray-300 rounded-lg w-full absolute z-0"
          />
          <button className="absolute z-10 w-8 border-none left-[90%] mt-2" onClick={()=>{setEmail(newEmail);
        setEditingmail(false)}}><MdOutlineDownloadDone size={25}/></button>
        </div> : <div className="w-full bg-yellow-400 relative">
                <input  
                  type="text"
                  value={email}
          ...
          <div className="w-[93%] flex flex-col gap-2 ">
              <p>Your Password</p>
              {edditingpassword?  <div className="w-full flex flex-col gap-2">
          <input
            type="password"
            value={newPassword}
          ...
          />
          <button className=" w-[140px] border-none text-green-400 text-sm " onClick={()=>{
