        ...
        <div className="flex flex-col items-center">
          <div className="flex w-4/5 lg:w-3/5 md:w-3/5 h-60 lg:h-full">
            <div className="flex flex-col w-4/12">
              <div
                className="h-40 w-full md:py-2 py-1 px-1 md:px-5 relative"
                onClick={showModal}
              >
                <Image
                  src={TempImage}
              ...
              <div
                className="md:h-80 h-60 md:py-2 py-1 px-1 w-full md:px-5 relative"
                onClick={showModal}
              >
                <Image
                  src={TempImage}
            ...
            <div className="flex flex-col w-4/12">
              <div
                className="h-60 md:py-2 py-1 relative w-full "
                onClick={showModal}
              >
                <Image
                  src={TempImage}
            ...
            <div className="flex flex-col w-4/12">
              <div
                className="h-80 py-1 md:py-2 md:px-5  relative px-1 w-full"
                onClick={showModal}
              >
                <Image
                  src={TempImage}
              ...
              <div
                className="h-40 md:py-2 md:px-5 py-1 px-1 relative w-full"
                onClick={showModal}
              >
                <Image
                  src={TempImage}
